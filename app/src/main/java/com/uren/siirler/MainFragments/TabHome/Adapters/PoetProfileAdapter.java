...
public class PoetProfileAdapter extends RecyclerView.Adapter {
    ...
    public PoetProfileAdapter(Activity activity, Context context,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecyclerView.ViewHolder viewHolder = new PoetProfileAdapter.MyViewHolder(itemView);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((PoetProfileAdapter.MyViewHolder) holder).setData(siir, position);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(Siir siir, int position) {
            ...
            if (sair != null) {
                ...
                UserDataUtil.setProfilePictureWithStroke(mContext, sairHashmap.get(siir.getSairId()), txtProfilePic, imgProfilePic, colorCode);
